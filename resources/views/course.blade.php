...
@section('content')
        <div class="grid grid-cols-3 gap-4">
            <div class="p-8 bg-gray-200 col-span-1">
                <ul class="flex flex-col">
                  <li class="font-medium text-sm text-gray-400 uppercase mb-4">Content</li>
            ...
            <div class="text-gay-700 col-span-2">
        ...
        <div class="text-center">
            ...
            <h2 class="text-xl text-gray-600">Improve your skills</h2>
        </div>
